        ...
        Center(
          ...
          borderRadius: BorderRadius.circular(12), // Rounded corners
            ...
            child: Container(
              ...
              child: Row(
              mainAxisAlignment: MainAxisAlignment.center, // Align the text at the center
              children: [
                Text(
                "C H A N G E   Y O U R  ",
                style: GoogleFonts.inter(
  ...
  Widget build(BuildContext context) 
  {
    return Scaffold(
      body: Stack(children: [
        ...
        Positioned(
          top: MediaQuery.of(context).size.height * 0.26, // Adjust the top position as needed
          left: MediaQuery.of(context).size.width * 0.07, // Adjust the left position as needed
          right: MediaQuery.of(context).size.width * 0.07, // Adjust the right position as needed
          child: Container(
            padding: const EdgeInsets.all(16.0),
          ...
          _buildTextField(weightController, 'Weight (in cm)', Icons.monitor_weight, keyboardType: TextInputType.number),
          const SizedBox(height: 16.0),
          _buildTextField(heightController, 'Height (in cm)', Icons.height, keyboardType: TextInputType.number),
              ],
            ),
          ),
        ),
